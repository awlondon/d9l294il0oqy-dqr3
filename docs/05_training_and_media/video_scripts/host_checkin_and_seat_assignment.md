# Host Training – “Check-In & Seat Assignment” (Video Script ~60–90s)

## Purpose
Show new Hosts how to greet, check in, assign seats, and set expectations.
...
**Scene 3 – Screen capture: Member profile + Assign Seat button.**
“Ask about their preference: quiet, open workspace, or closer to the play area. Then tap ‘Assign Seat’ to open the seat map.”

**Scene 4 – Seat map overlay, Host tapping an available seat.**
“Choose a green, available seat in the right zone. Set an expected duration, and confirm. The system creates a seat session so we know who is sitting where.”

**Scene 5 – Host walking member to their seat, pointing to the seat label & QR code.**
“At the desk, point out the seat label, like A-12, and the QR code. Explain how ordering works:”

**Scene 6 – Close-up of Host talking to member.**
“Say: ‘Scan this QR code to sign in at your seat. You can order food and drinks from here, and we’ll bring everything to you. No need to stand in line.’”

**Scene 7 – Host back at the stand, quick shot of dashboard with multiple active sessions.**
