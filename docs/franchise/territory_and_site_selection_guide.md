...
- **Protected area:** Exclusive territory defined by a radius or zip/postal code cluster; no corporate units inside the boundary without franchisee consent.
- **Expansion rights:** First right of refusal on adjacent territories when performance targets are met (AUV, member count, QA scores).
- **Performance gates:** Maintain required KPIs to retain exclusivity and development schedule.

## Site Selection Criteria
- **Rent guardrails:** Stay within the rent ranges in the Location Economics Playbook; validate CAM/NNN.
