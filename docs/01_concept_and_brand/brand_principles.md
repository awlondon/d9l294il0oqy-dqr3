...
- **Clear and calm:** Short sentences, direct instructions, and reassuring phrasing during check-in and safety moments.
- **Inclusive and modern:** Welcome all family structures and abilities; avoid gendered or exclusive language.
- **Playful restraint:** Delight through small moments (stickers, latte art, kids’ names on cubbies) without clutter or chaos.
...
## Signature Moments
- Welcome board listing today’s classes and party schedule.
- “Focus ready” trays (outlets, sanitizer, water carafes) placed in cowork areas each morning.
- “Play warm-up” routine at the top of each hour to reset toys and re-brief kids.
- Members-only perks: drink discounts, early booking windows, and surprise mini-treats for children.

## Guardrails for Franchisees
- Keep circulation clear: stroller parking zones marked and enforced.
- Avoid over-theming; favor timeless finishes over characters or licensed décor.
- Maintain sightlines from host stand to play entry; never obstruct with merchandise.
- Train to scripts; ad-lib only after the core safety and hospitality phrases are mastered.
