# Franchisee Economics Summary

- **Build-out cost ranges**: Vary by size—from compact urban (~$1.2–$1.5M) to neighborhood (~$1.6–$2.0M) to flagship-scale (~$2.0–$2.4M+).
  - Assumes TI/landlord allowances offset 10–20% of build-out; add contingency of 5–10% for permitting delays or equipment lead times.
- **Ramp-up timeline**: Expect 3–6 months from lease to opening with appropriate pre-opening marketing.
