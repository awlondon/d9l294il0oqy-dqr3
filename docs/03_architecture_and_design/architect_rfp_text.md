# Architect / Interior Designer RFP Text
...
**Deliverables**
- 2–3 test-fit options; finalized floor plan with adjacency rationale.
- Reflected ceiling/lighting plan and acoustics strategy for separating play and cowork zones.
- Finish boards and schedules; furniture layouts and specs (kid-friendly, commercial-grade).
- Permit set and construction documents with structural coordination for play elements.
- Optional: 3D renders for investor/landlord communications.

**Timeline**
- RFP release: [date]
- Proposal due: [date]
- Selection: [date]
- Target permit set: [date]
...
Please reply with your relevant experience (hospitality + family), proposed team, fee structure, and any clarifying questions. We will shortlist firms for brief interviews before award.
