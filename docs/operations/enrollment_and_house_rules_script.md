# Enrollment and House Rules Script
...
- Membership types and pricing, including prepaid options and sibling add-ons.
- Check-in with matching wristbands/QRs; authorized adults only for pick-up.
- Cancellation and pause basics: cancel before next billing date; pauses available for moves/health.

## Handling Issues
- “If something isn’t right, please tell me or the manager immediately—we want to fix it on the spot.”
- Briefly explain escalation steps for safety/behavior concerns and how incident notes are logged.
