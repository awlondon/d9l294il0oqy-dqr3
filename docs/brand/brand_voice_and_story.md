...
## Voice Principles
- **Warm and practical:** Speak with hospitality, clarity, and operational confidence.
- **Safety-first:** Reinforce trust, cleanliness, and supervision without sounding clinical.
- **Ownership mindset:** Celebrate local owners and teams who bring the concept to life in their communities.
- **Human + AI partnership:** Highlight that AI supports design and operations while people deliver the experience.

## Narrative Dos and Don’ts
- **Do** keep the founding date and co-founders consistent.
- **Do** anchor stories in real caregiver needs and outcomes.
- **Don’t** over-promise technology; position it as an assistive layer to human-led hospitality and safety.
- **Don’t** shift the founding moment to later in November or remove the AI collaboration element.
