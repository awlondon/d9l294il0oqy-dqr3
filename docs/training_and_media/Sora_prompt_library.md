...
Central index of prompts for batch generation; update as scripts evolve.

## Host Basics / Enrollment
...
- **Title:** Incident follow-up
  - **Module:** Manager/Shift Lead
  - **Purpose:** Manager calmly addresses parent after minor incident, reviews log on tablet, offers make-good.
  - **Prompt:** “Manager with tablet speaks empathetically to parent in quiet corner, shows incident note, offers complimentary drink, maintains professional, reassuring tone.”
